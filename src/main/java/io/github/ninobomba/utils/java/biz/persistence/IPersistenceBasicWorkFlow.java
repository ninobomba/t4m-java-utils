 ...
 */
@FunctionalInterface
public interface IPersistenceBasicWorkFlow<I, O, E extends Throwable> extends
        IPersistenceWorkFlowResolveEntity<I, O, E>,
        IPersistenceWorkFlowUpdateEntity<I, O, E>,
        IPersistenceWorkFlowValidateEntity<I, O, E> {
     ...
     */
    static <I, O, E extends Throwable> IPersistenceBasicWorkFlow<I, O, E> of(
     ...
     */
    default <R> IPersistenceBasicWorkFlow<I, R, E> andThen(
     ...
     */
    default <R> IPersistenceBasicWorkFlow<I, R, E> andThenChecked(
     ...
     */
    default <R> IPersistenceBasicWorkFlow<I, R, E> map(
     ...
     */
    default <R> IPersistenceBasicWorkFlow<I, R, E> transform(
     ...
     */
    default <R> IPersistenceBasicWorkFlow<I, R, E> flatMap(
            Function<? super O, ? extends IPersistenceBasicWorkFlow<O, R, E>> next
    ) {
        Objects.requireNonNull(next, "next cannot be null");
        return input -> {
            O current = execute(input);
            IPersistenceBasicWorkFlow<O, R, E> chained = Objects.requireNonNull(
     ...
     */
    default <V> IPersistenceBasicWorkFlow<V, O, E> compose(
     ...
     */
    default IPersistenceBasicWorkFlow<I, O, E> onSuccess(
     ...
     */
    default IPersistenceBasicWorkFlow<I, O, E> onFailure(
     ...
     */
    default IPersistenceBasicWorkFlow<I, O, E> recover(
     ...
     */
    default IPersistenceBasicWorkFlow<I, O, E> finallyDo(Runnable finalizer) {
     ...
     */
    default IPersistenceBasicWorkFlow<I, O, E> finallyDo(Consumer<? super I> finalizer) {
        Objects.requireNonNull(finalizer, "finalizer cannot be null");
     ...
     */
    default IPersistenceBasicWorkFlow<I, O, E> peek(Consumer<? super O> inspector) {
     ...
     */
    default IPersistenceBasicWorkFlow<I, O, E> identity() {
